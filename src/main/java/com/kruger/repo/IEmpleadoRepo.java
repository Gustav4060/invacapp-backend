...
public interface IEmpleadoRepo extends IGenericRepo<Empleado, Long> {
	...
	List<Empleado> listarEmpleadorPorEstadoVacunacion(@Param("estadoVacunacion") String estadoVacunacion);

	
	@Query(value="From Empleado e where e.tipoVacuna=:tipoVacuna")
	List<Empleado> listarEmpleadorPorTipoVacuna(@Param("tipoVacuna") String tipoVacuna);
